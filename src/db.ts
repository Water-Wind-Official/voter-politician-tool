	...
	const result = await db
		.prepare(`
			INSERT INTO voter_data (
				...
				voter_turnout_percentage, citizen_turnout_percentage, last_election_date,
			...
			ON CONFLICT(state_code, data_year) DO UPDATE SET
				...
				citizen_turnout_percentage = excluded.citizen_turnout_percentage,
		...
		.bind(
			...
			data.citizen_turnout_percentage || null,
